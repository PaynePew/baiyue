        ...
        <section className="relative w-full h-screen flex justify-center items-center">
            ...
            <div className="relative flex flex-col max-w-[312px] pt-[74px] pb-[103px] mx-[24px] md:max-w-none md:mx-[129px] md:pb-[92px] md:w-[510px] lg:flex-row lg:w-auto lg:gap-[126px]">
                ...
                <div className="relative h-fit py-[32px] mb-[80px] md:pt-[20px] md:pb-[27px] md:px-[30.5px] md:mb-[64px] lg:pt-[58px] lg:pb-[67px] lg:pl-[66px] lg:pr-[40px] ">
                    ...
                    {/* border-arrow-left */}
                    <div className="hidden md:block absolute left-0 h-full max-h-[95%] top-[50%] translate-y-[-50%]">
                        <div className="absolute h-full bg-grayscale-iron before:bg-grayscale-iron after:bg-grayscale-iron border-arrow-vertical"></div>
                    </div>
                    {/* border-arrow-right */}
                    <div className="hidden absolute md:block right-0 h-full max-h-[95%] top-[50%] translate-y-[-50%]">
                        <div className="absolute h-full bg-grayscale-iron before:bg-grayscale-iron after:bg-grayscale-iron border-arrow-vertical"></div>
                    </div>
                    {/* border-arrow-bottom*/}
