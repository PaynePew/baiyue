        ...
        <section className="w-full bg-grayscale-iron">
            ...
            <div className="flex flex-col pt-[131px] mx-[24px] gap-[32px] mb-[60.5px] md:mx-[40px] md:pt-[200px] md:gap-[64px] lg:pt-[120px] lg:mx-[120px] lg:gap-[80px] ">
                <div className="flex flex-col justify-center items-center gap-[12px]">
                    <h2 className="text-grayscale-gainsboro text-center">臺北市殯葬管理處第二殯儀館二期整建工程</h2>
                ...
                <div className="w-full flex justify-center items-center">
                    <img
                        ...
                        className="w-full object-cover rounded-[12px] md:w-[510px] md:rounded-[16px]"
                        alt="project_img"
                    />
                </div>
                <div className="w-full flex flex-col gap-[16px]">
                    <div className="flex flex-col gap-[16px]">
                        <div className="flex flex-col p-[24px] gap-[12px] bg-grayscale-dim rounded-[12px] project-detail-shadow-1">
                            <div className="body-3 text-grayscale-light">專案類型</div>
                            <div className="body-2 text-white">施工階段/建築、結構、景觀、機電</div>
                        </div>
                        <div className="flex flex-col p-[24px] gap-[12px] bg-grayscale-dim rounded-[12px] project-detail-shadow-1">
                            <div className="body-3 text-grayscale-light">合作單位</div>
                            <div className="body-2 text-white">應州工程有限公司，楊瑞禎聯合建築師事務所</div>
                        </div>
                        <div className="flex flex-col p-[24px] gap-[12px] bg-grayscale-dim rounded-[12px] project-detail-shadow-1">
                            <div className="body-3 text-grayscale-light">專案內容</div>
                            <div className="body-2 text-white">地上5層，地下4層，約19,791㎡</div>
                        </div>
                    </div>
                    <div className="flex flex-col p-[24px] gap-[24px] bg-grayscale-dim rounded-[12px] project-detail-shadow-1">
                                ...
                                {flow.map(({ step, desc }, idx) => {
                                    return (
                                        <>
                                            <div
                                                key={idx}
                                                className="flex flex-col w-[109px] h-[122px] py-[16px] px-[20px] gap-[8px] border-[1px] border-solid border-grayscale-light/50 rounded-[16px]"
                                            >
                                                <div className="en-minimum text-grayscale-silver">{step}</div>
                                                <div className="body-3 text-grayscale-gainsboro">{desc}</div>
                                            </div>
                                            <img
                                                className="w-[6px] h-[12px] last:hidden"
